...
Document how AI was used during the exercise.

Explain that:

* ChatGPT, Gemini, Claude, and Cursor were used as engineering assistants.
* ChatGPT and Gemini were primarily used for prompt refinement, architectural discussions, and technical questions.
* Cursor was used as the primary IDE agent and implementation assistant.
* Claude was used for focused code reviews and alternative solutions.
* Project-specific rules located in `.cursor/rules/` helped guide architecture, testing, and development standards.

Mention any prompt documentation found in the repository if it objectively exists.

---

## 6. Prompt Transcript

Include a dedicated section containing the prompts used for this exercise.

If prompt files exist in the repository, reference them.

If prompts are documented elsewhere, mention their location.

Leave placeholders if user input is required.
