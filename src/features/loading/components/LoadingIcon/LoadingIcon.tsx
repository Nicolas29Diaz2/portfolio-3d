import type { LoadingIconProps } from '@/features/loading/types/loading.types'
import './LoadingIcon.css'

export function LoadingIcon({
  progress,
  hideLoadingLogo,
}: Readonly<LoadingIconProps>) {
  return (
    <div
      className={`loading-icon-container ${hideLoadingLogo ? 'loading-icon-scale-out' : ''}`}
    >
      <div className="loading-icon-fill-container">
        <div
