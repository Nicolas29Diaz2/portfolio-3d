...
import { useProductsCatalog } from "@/features/products/hooks/useProductsCatalog.service";
import { useProductsPageCms } from "@/features/products/hooks/useProductsPage.service";
import "./ProductsPage.css";

export function ProductsPage() {
  const { products, isLoading: isCatalogLoading, hasError } =
    useProductsCatalog();
